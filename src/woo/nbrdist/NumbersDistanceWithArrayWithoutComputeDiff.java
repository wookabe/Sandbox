 ...
 */
public class NumbersDistanceWithArrayWithoutComputeDiff {
    private final String filePath;

    public NumbersDistanceWithArrayWithoutComputeDiff(String filePath) {
    ...
    private Point[] readFile(Point toPoint) throws IOException, InterruptedException {
